...
import { 
  ...
  ChevronDown, ChevronUp, Search, Monitor, Smartphone, ScanBarcode
} from "lucide-react";
      ...
      {isCameraOpen && (
        <div className="fixed inset-0 z-50 bg-black/95 flex flex-col items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="relative w-full max-w-2xl bg-black rounded-3xl overflow-hidden shadow-2xl border border-gray-800 aspect-3/4 md:aspect-video">
            ...
            {/* Overlay Guide */}
            <div className="absolute inset-0 border-40 border-black/40 flex items-center justify-center pointer-events-none">
        ...
        {!image && !result && (
          <div className="flex flex-col md:flex-row items-center justify-center min-h-[60vh] gap-12 animate-in slide-in-from-bottom-5 duration-500">
            ...
            <div className="flex-1 flex justify-center md:justify-end opacity-80 md:opacity-100">
              <div className="relative w-64 h-64 md:w-80 md:h-80 bg-linear-to-tr from-blue-100 to-purple-50 rounded-full flex items-center justify-center animate-pulse-slow shadow-2xl shadow-blue-100">
                  ...
                  {/* Decorations around the illustration */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 animate-in fade-in duration-500">
            ...
            <div className="lg:col-span-5 xl:col-span-4">
              <div className="lg:sticky lg:top-28 space-y-4">
                ...
                {result && (
                  <button 
                    onClick={() => { setImage(null); setResult(null); setShowIngredients(false); }}
                    className="w-full bg-white text-gray-700 font-bold py-4 rounded-2xl border-2 border-gray-200 hover:bg-gray-50 hover:border-gray-300 transition-all flex items-center justify-center gap-2"
                  >
            ...
            <div className="lg:col-span-7 xl:col-span-8 space-y-6 pb-20">
              ...
              {result && (
                <>
                  {/* Header */}
                  <div className="bg-white rounded-4xl p-6 md:p-8 shadow-xl border border-blue-50 relative overflow-hidden">
                        ...
                        {result.allergen_list.length > 0 && (
                            <div className="p-5 bg-orange-50/30 flex gap-4">
                              ...
                              <div>
                                  ...
                                  <p className="text-sm text-gray-600 mt-1">This product contains: <b>{result.allergen_list.join(", ")}</b></p>
                              </div>
                            </div>
                        )}
                  ...
                  <div className="border border-gray-200 rounded-xl overflow-hidden bg-white shadow-sm">
                      ...
                      {showIngredients && (
                        <div className="p-6 bg-white border-t border-gray-200 animate-in slide-in-from-top-2">
                            ...
                            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 text-xs font-mono text-gray-600 whitespace-pre-wrap wrap-break-word leading-relaxed">
